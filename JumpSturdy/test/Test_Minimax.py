...
from ai.Minimax_array import minimax2 
#Test if Minimax gets the best Move (Projekt Wiki)
...
def load_tests(loader, tests, pattern):
    ...
    suite.addTest(TestMinimax('test_minimax'))
    return suite
