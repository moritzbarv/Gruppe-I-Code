...
from board.Array import game_over, generate_moves, change_board, print_board
from ai.Bewertungsfunktion_array import evaluate_position
from ai.Zugsortierung_array import generate_capture_moves, generate_end_moves, order_moves, order_moves2
...
def minimax_pvs_ruhesuche(board, move, depth, alpha, beta, maximizingP, color, total_time, states_checked, zuege):
    ...
    if game_over(board, color):
        ...
        #print('evaluate the position')
        #print_board(board)
        eval_val, states_checked = ruhesuche(board, alpha, beta, color, maximizingP, states_checked, dep = 0)  #Anstatt Evaluate : Ruhesuche
        #print('Move ' , move)
        #print('Evaluation: ', eval_val)
        return (eval_val, move, states_checked)
